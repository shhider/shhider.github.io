...
layout: post
category: code
title: 【翻译】Clean Code for JavaScript
---

> 原文地址：[https://github.com/ryanmcdermott/clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)

## 简介

![WTFs/minute](/public/img/clean-code-js-01.jpeg)
*唯一有效的代码质量度量方式：WTFs/min*

Software engineering principles, from Robert C. Martin's book Clean Code, adapted for JavaScript. This is not a style guide. It's a guide to producing readable, reusable, and refactorable software in JavaScript.

软件开发原则，从Robert C. Martin的书——《Clean Code》，为JavaScript做了适配。这不是一篇风格指南，而是知道你可阅读的、可重用的、可重复分解的JavaScript代码。

Not every principle herein has to be strictly followed, and even fewer will be universally agreed upon. These are guidelines and nothing more, but they are ones codified over many years of collective experience by the authors of Clean Code.

以下的原则，不是每一条都必须严格遵守的，甚至只有一小部分是被普遍认同的。虽然这些只是指导原则，但也是《Clean Code》的作者多年来的经验编撰而成的。

Our craft of software engineering is just a bit over 50 years old, and we are still learning a lot. When software architecture is as old as architecture itself, maybe then we will have harder rules to follow. For now, let these guidelines serve as a touchstone by which to assess the quality of the JavaScript code that you and your team produce.

软件开发这个行业到现在仅50年出头，我们依然要学习很多东西。当软件架构与架构本身一样久时，也许我们会有更明确的规则去遵守。而现在，就让这些指南作为试金石，来评估你和你的团队产出的JavaScript代码。

One more thing: knowing these won't immediately make you a better software developer, and working with them for many years doesn't mean you won't make mistakes. Every piece of code starts as a first draft, like wet clay getting shaped into its final form. Finally, we chisel away the imperfections when we review it with our peers. Don't beat yourself up for first drafts that need improvement. Beat up the code instead!

你还需要知道的是，了解这些指南并不会立即让你成为更厉害的开发者，应用了这些指南也不会让你避免所有的错误。每一段代码都像一堆黏土一样，从毛坯慢慢塑造成最终的形态。最后，我和我的同伴在审查时已经尽可能地剔除不足之处。不要因为尚待完善的代码否定你自己，而是去改变这些代码！
...
开发者读过的代码通常要比写的代码还要多。编写可阅读、可检索的代码无疑是非常重要的。当我们没有给一些变量冠以有意义的名称，程序就会变得难以理解，让其他阅读我们代码的人很蛋疼。所以请使用可检索的变量名称，像buddy.js和ESLint这些工具可以帮助我们识别没有命名的常量。
...
如果你的类或者对象已经告诉你这是什么了，就不要再在属性名中重复了。
...
你可以使用ES6的解构语法（译者：[解构赋值](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment)），清晰地分辨参数对象需要的属性。这样做的好处是：
